...
<script type="text/javascript">
        ...
        function addPriceInput(divName){
            ...
            newdiv.innerHTML += '<p class="event_form_field ee_fem_form_field dynamic-price-input-field"><label for="reservation-' + (next_counter) + '" ><?php _e("Reservation", "event_espresso"); ?></label> ';
            newdiv.innerHTML += <?php echo "'".select_input('reservation', $values, $price->reservation)."'"; ?>;
            newdiv.innerHTML += ' </p>';
